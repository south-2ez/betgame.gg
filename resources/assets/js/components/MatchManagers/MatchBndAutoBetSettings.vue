<template>
	<div>
		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#bnd-threshold-settings-modal">
			<i class="fa fa-sort" aria-hidden="true"></i> BND Bet Settings
		</button>

		<div
			class="modal fade"
			id="bnd-threshold-settings-modal"
			tabindex="-1"
			role="dialog"
			aria-hidden="true"
